const { userRegister, renderRegisterPage, renderLoginPage, userLogin, renderHomepage, renderForgotPasswordPage, handleForgotPassword, renderVerifyOTP, veryfyOtp, renderResetPassword, handleResetPassword } = require("../controllers/authController");
